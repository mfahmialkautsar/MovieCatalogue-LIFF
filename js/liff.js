function startLiff() {
  ...
  // const defaultLiffId = "YOUR_LIFF_ID";   // change the default LIFF value if you are not using a node server
...
function displayIsInClientInfo() {
  if (liff.isInClient()) {
    ...
    document.querySelector('.buttonRow').classList.toggle('hidden');
  }
}
